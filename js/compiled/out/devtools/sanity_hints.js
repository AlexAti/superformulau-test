...
var reader = (function (){var or__21707__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__21707__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__21707__auto__)){
return or__21707__auto__;
} else {
return (128);
...
var map__37200 = top_item;
var map__37200__$1 = ((((!((map__37200 == null)))?((((map__37200.cljs$lang$protocol_mask$partition0$ & (64))) || (map__37200.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__37200):map__37200);
var file = cljs.core.get.call(null,map__37200__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__37200__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__37200__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e37199){var _e = e37199;
return false;
}});
devtools.sanity_hints.type_error_to_string = (function devtools$sanity_hints$type_error_to_string(self){
var temp__4655__auto___37202 = devtools.sanity_hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___37202)){
var seen_errors_37203 = temp__4655__auto___37202;
if(cljs.core.truth_(seen_errors_37203.has(self))){
} else {
seen_errors_37203.add(self);

var temp__4657__auto___37204 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___37204)){
var sense_37205 = temp__4657__auto___37204;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_37205)].join('');
} else {
}
}
} else {
...
if(cljs.core.truth_((function (){var and__21695__auto__ = cljs.core.not.call(null,devtools.sanity_hints._STAR_installed_QMARK__STAR_);
...
//# sourceMappingURL=sanity_hints.js.map?rel=1474548516317