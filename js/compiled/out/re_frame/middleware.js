...
re_frame.utils.log.call(null,"Handling re-frame event: ",v);

var new_db = handler.call(null,db,v);
var diff = clojure.data.diff.call(null,db,new_db);
re_frame.utils.group.call(null,"clojure.data/diff for: ",v);
...
var G__36953__i = 0, G__36953__a = new Array(arguments.length -  0);
while (G__36953__i < G__36953__a.length) {G__36953__a[G__36953__i] = arguments[G__36953__i + 0]; ++G__36953__i;}
  args = new cljs.core.IndexedSeq(G__36953__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__36954){
var args = cljs.core.seq(arglist__36954);
...
return cljs.core.get_in.call(null,new_db,p1__36955_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__36956_SHARP_){
return cljs.core.get_in.call(null,db,p1__36956_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__36957__i = 0, G__36957__a = new Array(arguments.length -  2);
while (G__36957__i < G__36957__a.length) {G__36957__a[G__36957__i] = arguments[G__36957__i + 2]; ++G__36957__i;}
  in_paths = new cljs.core.IndexedSeq(G__36957__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__36958){
var f = cljs.core.first(arglist__36958);
arglist__36958 = cljs.core.next(arglist__36958);
var out_path = cljs.core.first(arglist__36958);
var in_paths = cljs.core.rest(arglist__36958);
...
//# sourceMappingURL=middleware.js.map?rel=1474548515500